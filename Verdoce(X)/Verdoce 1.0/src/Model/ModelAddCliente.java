...
public class ModelAddCliente {
    ...
    private ArrayList<ModelVerdoce> listaVer = new ArrayList<ModelVerdoce>();
    private static ArrayList<ModelAddCliente> listaCliente = new ArrayList<ModelAddCliente>();
    
    public ModelAddCliente(
            String nome,
            String sobreNome,
            String sexo,
            String cpf, 
    ...
    public static ArrayList<ModelAddCliente> getListaClilente(){
        return listaCliente;
    }
}
